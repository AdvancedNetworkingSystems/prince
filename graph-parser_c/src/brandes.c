...
/*
 ...
 struct graph g1;
 init_graph(&g1);
 add_edge_graph(&g1,"0","3",9.66453535692,0);
 add_edge_graph(&g1,"1","2",4.40732599175,0);
 add_edge_graph(&g1,"1","3",0.0749147005859,0);
 add_edge_graph(&g1,"2","3",9.10975962449,0);
