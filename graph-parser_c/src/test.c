...
int main()
{
    ...
    struct list *l = tarjan_iter_dir(&g, is_articulation_point, component_indexes);
    ...
    for (; nl4 != 0; nl4 = nl4 -> next)
    {
        ...
        printf("%s %d\n", ng -> name, is_articulation_point[ng -> node_graph_id]);
    }
...
map_id_degree_bc * bc_degree_map = (map_id_degree_bc *)
