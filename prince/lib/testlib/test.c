 ...
 */
routing_plugin *new_plugin(char *host, int port, c_graph_parser *gp,
                           int json_type, int timer_port)
{
        ...
        o->self_id = 0;
        o->timer_port =
            timer_port; // the port is the same for netjson and poprouting
        return o;
}
...
int push_timers(routing_plugin *o, struct timers t)
{
        ...
        char cmd[25];
        // sprintf(cmd,
        // "/HelloTimer=%4.4f/TcTimer=%4.4f/exec_time=%4.4f/centrality=%4.4f",
